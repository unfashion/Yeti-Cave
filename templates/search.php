    ...
    <div class="container">
        ...
        ?>
            <ul class="pagination-list">
                <li class="pagination-item pagination-item-prev"><a <?= $page > 1 ? "href=/search.php?search=$query&page=$prev_page" : '' ?>>Назад</a></li>
                <?php for ($i = 1; $i <= $page_count; $i++) : ?>
                    <li class="pagination-item <?= $i == $page ? 'pagination-item-active' : '' ?>"><a href="/search.php?search=<?= $query ?>&page=<?= $i ?>"><?= $i ?></a></li>
                <?php endfor ?>
                <li class="pagination-item pagination-item-next"><a <?= $page < $page_count ? "href=/search.php?search=$query&page=$next_page" : '' ?>>Вперед</a></li>
            </ul>
        <?php endif ?>
    </div>
</main>