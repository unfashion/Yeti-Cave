    ...
    <form class="form form--add-lot container form--invalid" action="/add.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form__container-three">
            <div class="form__item form__item--small <?= $errors['lot_rate'] ? 'form__item--invalid' : '' ?>">
                ...
                <input id="lot-rate" type="text" name="lot_rate" placeholder="0">
            ...
            <div class="form__item form__item--small <?= $errors['lot_step'] ? 'form__item--invalid' : '' ?>">
                ...
                <input id="lot-step" type="text" name="lot_step" placeholder="0">
            ...
            <div class="form__item <?= $errors['lot_date'] ? 'form__item--invalid' : '' ?>">
                ...
                <input class="form__input-date" id="lot-date" type="text" name="lot_date" placeholder="Введите дату в формате ГГГГ-ММ-ДД">
